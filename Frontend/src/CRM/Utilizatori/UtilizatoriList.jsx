...
import {
    faPenToSquare, faTrash, faEllipsis, faClock,
    faEnvelope, faPhone, faUserTie, faShield,
    faBuilding, faToggleOn, faToggleOff,
    faCalendar,
    faChainSlash,
    faChain
    ...
    TableRow: (props) => {
        ...
        return (
            <ContextMenu>
                ...
                <ContextMenuContent>
                    <ContextMenuItem className="gap-2 text-primary focus:text-primary font-semibold" onClick={() => props.context?.handleAtribuiriClick(cont?.id)}>
                    ...
                    <ContextMenuItem
                        ...
                        onClick={() => props.context?.handleDeleteClick({ id: cont.id, nume: cont.name })}
                    >
...
// ── Main Component ─────────────────────────────────────────────────────────
export default function UtilizatoriList({
    conturi = [],
    visibleColumns = {},
    handleEdit,
    handleDeleteClick,
    ...
    const handleScroll = (e) => { scrollPosRef.current = e.target.scrollTop; };
    ...
    if (isCardView) {
        return (
            ...
            >
                            ...
                            >
                                {rowItems.map((cont) => {
                                    ...
                                    return (
                                        <Card
                                            key={cont.id}
                                            className={`group flex flex-col justify-between shadow-base   border-4 border-border transition-all duration-200 bg-card hover:shadow-md ${cardOpacity}`}
                                        >
                                                ...
                                                <div className="flex gap-4 mb-4">
                                                    <div className="relative shrink-0">
                                                        <Avatar className="h-16 w-16 rounded-lg border border-border">
                                                            ...
                                                            <AvatarFallback className="text-base font-bold text-foreground bg-muted rounded-lg">
                                                                {initials}
                                                            </AvatarFallback>
                                                        </Avatar>
                                                    </div>
                                                    ...
                                                    <div className="flex-1 min-w-0 flex flex-col justify-center">
                                                        <div className="flex justify-between items-start">
                                                            <h3 className="font-bold text-base text-foreground truncate pr-1 leading-tight">
                                                                {cont.name}
                                                            </h3>
                                                            <DropdownMenu>
                                                                ...
                                                                <DropdownMenuContent className="font-semibold" align="end">
                                                                    ...
                                                                    <DropdownMenuItem
                                                                        ...
                                                                        onClick={() => handleDeleteClick({ id: cont.id, nume: cont.name })}
                                                                    >
                                                        ...
                                                        <div className="flex items-center gap-2 mt-1 flex-wrap">
                                                            {cont.activ ? (
                                                                ...
                                                                <Badge variant="destructive" className="shadow-none px-1.5 h-5 text-sm">Inactiv</Badge>
                                                            )}
                                                ...
                                                <div className="space-y-2 pt-2 border-t border-border">
                                                    <div className="flex items-center justify-between gap-2 text-base">
                                                        ...
                                                        {cont.companie_interna_color ? (
                                                            <span className="font-medium  truncate flex items-center gap-1.5 p-1 px-2 rounded-lg"
                                                                style={{
                                                    ...
                                                    <div className="flex items-center justify-between gap-2 text-base">
                                                        ...
                                                        <span
                                                            ...
                                                            onClick={(e) => { if (cont.email) { e.stopPropagation(); window.location.href = `mailto:${cont.email}`; } }}
                                                        >
                                                            {cont.email || "—"}
                                                        </span>
                                                    </div>
                                                    ...
                                                    <div className="flex items-center justify-between gap-2 text-base">
                                                        ...
                                                        <span
                                                            ...
                                                            onClick={(e) => { if (cont.telephone) { e.stopPropagation(); window.location.href = `tel:${cont.telephone}`; } }}
                                                        >
                                                            {cont.telephone || "—"}
                                                        </span>
                                                    </div>
                                                    <div className="flex items-center justify-between gap-2 text-base">
                                                        ...
                                                        <span
                                                            className={`truncate text-base ${cont.data_nastere ? "text-foreground cursor-pointer hover:text-primary transition-colors" : "text-muted-foreground"}`}
                                                        >
                ...
                {conturi.length === 0 && (
                    <div className="text-center p-10 text-muted-foreground">Nu există utilizatori.</div>
                )}
            </div>
        );
    }
                    ...
                    <>
                        ...
                        {showCol('companie') && (
                            <TableCell className="px-4 text-center whitespace-nowrap">
                                <span
                                    className="flex items-center justify-center gap-1.5 py-2  rounded-lg text-base text-foreground"
                                    style={{ backgroundColor: cont.companie_interna_color }}
                                >
                                    <span
                                        style={{ color: getContrastColor(cont.companie_interna_color) }}
                                    >
                                        {cont.nume_companie_interna || "—"}
                                    </span>
                                </span>
                            ...
                            <TableCell className="px-4 text-center whitespace-nowrap">
                                {cont.email ? (
                                    <span
                                        ...
                                        onClick={(e) => { e.stopPropagation(); window.location.href = `mailto:${cont.email}`; }}
                                    >
                                        {cont.email}
                                    </span>
                        ...
                        {showCol('telefon_munca') && (
                            <TableCell className="px-4 text-center whitespace-nowrap">
                                {cont.telephone ? (
                                    <span
                                        className="text-base text-foreground hover:text-primary cursor-pointer transition-colors"
                                        onClick={(e) => { e.stopPropagation(); window.location.href = `tel:${cont.telephone}`; }}
                                    >
                        ...
                        {showCol('telefon_personal') && (
                            <TableCell className="px-4 text-center whitespace-nowrap">
                                {cont.telephone_1 ? (
                                    <span
                                        className="text-base text-foreground hover:text-primary cursor-pointer transition-colors"
                                        onClick={(e) => { e.stopPropagation(); window.location.href = `tel:${cont.telephone_1}`; }}
                                    >
                        ...
                        {showCol('status') && (
                            <TableCell className="px-4 text-center whitespace-nowrap">
                                {cont.activ
                                    ...
                                    : <Badge variant="destructive" className="w-16 text-center items-center justify-center shadow-none p-2 text-base">Inactiv</Badge>
                                }
                            </TableCell>
                        )}
                        ...
                        {showCol('actualizat') && (
                            <TableCell className="px-4 text-center whitespace-nowrap">
                                <div className="flex flex-col items-center gap-0.5">
                                    ...
                                    {cont.updated_by_name && (
                                        <span className="text-sm text-muted-foreground">{cont.updated_by_name}</span>
                                    )}
                                </div>
                            </TableCell>
                        )}
                        ...
                        {showCol('creat') && (
                            <TableCell className="px-4 text-center whitespace-nowrap">
                                <div className="flex flex-col items-center gap-0.5">
                                    ...
                                    {cont.created_by_name && (
                                        <span className="text-sm text-muted-foreground">{cont.created_by_name}</span>
                                    )}
                                </div>
                            </TableCell>
                        )}
