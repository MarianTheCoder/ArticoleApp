...
export default function CompanyHistory({ companyId, filialaId = null, santierId = null }) {
    ...
    const getEntityIcon = (type) => {
        switch ((type || "").toLowerCase()) {
            case 'contact': return faUser;
            case 'santier': return faMapLocationDot;
            case 'filiala': return faCodeBranch;
            case 'companie': return faCity;
            default: return faCity;
        }
    };
    ...
    const getEntityLabel = (type) => {
        switch ((type || "").toLowerCase()) {
            ...
            case 'santier': return 'Șantier';
            case 'filiala': return 'Filială';
            case 'companie': return 'Companie';
            default: return type;
        }
    };
    ...
    const getActionType = (action) => {
        ...
        if (lower.includes('delet') || lower.includes('șter') || lower.includes('ster')) return 'delete';
        if (lower.includes('creat') || lower.includes('ad')) return 'create';
        return 'unknown';
    };
    ...
    const getActionBadgeStyle = (type) => {
        switch (type) {
            ...
            default: return "text-primary border border-primary bg-transparent";
        }
    };
                                    ...
                                    <div key={item.id} className="flex flex-col">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="flex gap-2 items-center justify-between w-full">
                                                <div className="flex flex-wrap items-center gap-3 text-base">
                                                    ...
                                                    <Badge
                                                        variant="secondary"
                                                        className="text-sm font-semibold shadow-sm flex items-center gap-2 py-1 border-foreground px-2 "
                                                    >
                                        ...
                                        <div className={`flex-1 ml-6 border-l-2 border-b-2 rounded-bl-3xl ${borderColor} pl-6 pb-6`}>
                                            <div className=" text-lg font-bold text-foreground leading-relaxed">
                                                {item.title ? item.title : <span className="italic text-muted-foreground">Fără titlu.</span>}
                                            </div>
                                            {/* Message Body */}
                                            <div className=" text-base mt-1 text-foreground leading-relaxed">
                                                {item.message ? item.message : <span className="italic text-muted-foreground">Fără mesaj.</span>}
                                            </div>
