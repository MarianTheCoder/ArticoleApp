...
function Navbar() {
  ...
  const handleFilialaClick = (filialaId) => {
    setExpandedFiliale((prev) => (prev.includes(filialaId) ? prev.filter((id) => id !== filialaId) : [...prev, filialaId]));
  };
          ...
          <ul className="flex flex-col gap-1 select-none">
            ...
            >
              <div className="flex items-center w-full">
                <FontAwesomeIcon className={`text-base w-6 mr-1 transition-transform ${crmOpen ? "rotate-90" : ""}`} icon={faChevronRight} />
                <div className="flex items-center gap-3">
            ...
            {crmOpen && (
              <div className="ml-3 pl-3 border-l border-border space-y-1">
                ...
                <div className="text-lg cursor-pointer rounded-lg px-3 py-2 hover:bg-accent transition border border-transparent hover:border-border" onClick={() => navigate("/CRM")}>
                  <div className="flex items-center w-full">
                ...
                <div className="text-lg cursor-pointer rounded-lg px-3 py-2 hover:bg-accent transition border border-transparent hover:border-border" onClick={() => navigate("/CRM/Companii")}>
                  <div className="flex items-center w-full">
                    <div className="flex items-center gap-3 pl-7">
                ...
                <div className="text-lg cursor-pointer rounded-lg px-3 py-2 hover:bg-accent transition border border-transparent hover:border-border" onClick={() => navigate("/CRM/Filiale")}>
                  <div className="flex items-center w-full">
                    <div className="flex items-center gap-3 pl-7">
                ...
                <div className="text-lg cursor-pointer rounded-lg px-3 py-2 hover:bg-accent transition border border-transparent hover:border-border" onClick={() => navigate("/CRM/Santiere")}>
                  <div className="flex items-center w-full">
                    <div className="flex items-center gap-3 pl-7">
                ...
                <div className="text-lg cursor-pointer rounded-lg px-3 py-2 hover:bg-accent transition border border-transparent hover:border-border" onClick={() => navigate("/CRM/Contacte")}>
                  <div className="flex items-center w-full">
                    <div className="flex items-center gap-3 pl-7">
                      <div className="w-7 h-7 grid place-items-center rounded-lg text-blue-600">
            ...
            >
              <div className="flex items-center w-full">
                <FontAwesomeIcon className={`text-base w-6 mr-1 transition-transform ${bazaDeDateOpen ? "rotate-90" : ""}`} icon={faChevronRight} />
                <div className="flex items-center gap-3">
            ...
            {bazaDeDateOpen && (
              <div className="ml-3 pl-3 border-l border-border space-y-1">
                ...
                >
                  <div className="flex items-center w-full">
                    <FontAwesomeIcon className={`text-base w-6 mr-1 transition-transform ${dateOpen ? "rotate-90" : ""}`} icon={faChevronRight} />
                    <div className="flex items-center gap-3">
                ...
                {dateOpen && (
                  <div className="ml-3 pl-3 border-l border-border space-y-1">
                    <div onClick={() => navigate("/addArticles")} className="text-[0.95rem] px-3 py-2 rounded-lg hover:bg-accent transition flex items-center gap-3 group">
                    ...
                    <div onClick={() => navigate("/addManopere")} className="text-[0.95rem] px-3 py-2 rounded-lg hover:bg-accent transition flex items-center gap-3 group">
                    ...
                    <div onClick={() => navigate("/addMateriale")} className="text-[0.95rem] px-3 py-2 rounded-lg hover:bg-accent transition flex items-center gap-3 group">
                      <span className="w-6 text-amber-600">
                    ...
                    <div onClick={() => navigate("/addTransport")} className="text-[0.95rem] px-3 py-2 rounded-lg hover:bg-accent transition flex items-center gap-3 group">
                      <span className="w-6 text-emerald-500  ">
                        <FontAwesomeIcon className="text-base" icon={faCar} />
                      </span>
                      <span className="group-hover:translate-x-0.5 transition">Transport</span>
                    </div>

                    <div onClick={() => navigate("/addUtilaje")} className="text-[0.95rem] px-3 py-2 rounded-lg hover:bg-accent transition flex items-center gap-3 group">
                ...
                <div className="text-lg cursor-pointer rounded-lg px-3 py-2 hover:bg-accent transition border border-transparent hover:border-border" onClick={() => navigate("/ManageConturi")}>
                  <div className="flex items-center w-full">
                    <div className="flex items-center gap-3 pl-7">
                ...
                <div className="text-lg cursor-pointer rounded-lg px-3 py-2 hover:bg-accent transition border border-transparent hover:border-border" onClick={() => navigate("/Pontaje")}>
                  <div className="flex items-center w-full">
                    <div className="flex items-center gap-3 pl-7">
      ...
      border border-transparent hover:border-border mt-1"
            ...
            >
              <div className="flex items-center jusc w-full">
                <FontAwesomeIcon className={`text-base w-6 mr-1 transition-transform ${santiereOpen ? "rotate-90" : ""}`} icon={faChevronRight} />
                <div className="flex items-center gap-3">
              ...
              <div className="ml-3 pl-3 border-l border-border space-y-1">
                {companies
                  .filter((company) => {
                    ...
                    if (company.santiere?.some((site) => normalize(site.nume || "").includes(searchLower))) return true;

                    // Check if any filiala or filiala site matches
                    if (
                      company.filiale?.some(
                        (filiala) => normalize(filiala.nume_filiala || "").includes(searchLower) || filiala.santiere?.some((site) => normalize(site.nume || "").includes(searchLower)),
                      )
                    )
                      return true;
                  ...
                  .map((company) => (
                    <div key={company.id}>
                      ...
                      >
                        <FontAwesomeIcon className={`text-base w-6 mr-2 transition-transform ${expandedCompanies.includes(company.id) ? "rotate-90" : ""}`} icon={faChevronRight} />
                        <div className="flex items-center gap-3">
                          ...
                          <span className="w-full overflow-hidden whitespace-nowrap text-ellipsis">{company.nume_companie}</span>
                        </div>
                      </div>
                          ...
                          {company.santiere &&
                            company.santiere.map((site) => (
                              ...
                              >
                                ...
                                <div className="w-full text-base overflow-hidden whitespace-nowrap text-ellipsis">{site.nume}</div>
                              </div>
                            ))}

                          {/* Filiale rows (level3 with chevron) - show all when company is expanded */}
                          {company.filiale &&
                            company.filiale.map((filiala) => (
                              <div key={filiala.id}>
                                <div
                                  onClick={() => handleFilialaClick(filiala.id)}
                                  className={`text-lg cursor-pointer rounded-lg  px-3 py-2 hover:bg-accent transition border border-transparent flex items-center`}
                                >
                                  <FontAwesomeIcon className={`text-sm w-5 mr-1 transition-transform ${expandedFiliale.includes(filiala.id) ? "rotate-90" : ""}`} icon={faChevronRight} />
                                  <div className="flex items-center gap-2 overflow-hidden">
                                    <div className="w-7 h-7 grid p-1 place-items-center rounded-lg text-cyan-500">
                                      <FontAwesomeIcon icon={faBuilding} />
                                    </div>
                                    <div className={`w-full text-base overflow-hidden  whitespace-nowrap text-ellipsis`}>{filiala.nume_filiala}</div>
                                  </div>
                                </div>
                ...
                {searchTermDebounced &&
                  companies.filter((company) => {
                    const searchLower = normalize(searchTermDebounced);
                    return (
                      normalize(company.nume_companie || "").includes(searchLower) ||
                      company.santiere?.some((site) => normalize(site.nume || "").includes(searchLower)) ||
                      company.filiale?.some(
                        (filiala) => normalize(filiala.nume_filiala || "").includes(searchLower) || filiala.santiere?.some((site) => normalize(site.nume || "").includes(searchLower)),
                      )
                    );
                  }).length === 0 && <div className="text-center py-4 text-muted-foreground">Nu s-au găsit rezultate pentru "{searchTermDebounced}"</div>}
              </div>
            )}
          </ul>
        </div>
            ...
            <div className="grid grid-rows-[auto_1fr_auto] ">
              {viewSearch && (
                <div className="py-1 mb-3 pl-1 relative">
                  <Input placeholder="Caută companie, filială, șantier..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="pr-8" autoFocus />
                  {searchTermDebounced && (
                    <Button
                      variant="ghost"
                      onClick={() => {
              ...
              <div className="py-1 overflow-hidden mb-3 pl-1">
                <div className="flex items-center gap-3 w-full">
                  ...
                  >
                    <img className="w-full h-full object-cover rounded-lg" src={userData?.photo_url ? `${photoAPI}/${userData.photo_url}` : photo} alt={user.name} />
                  </div>
                  ...
                  <div className="flex w-full overflow-hidden justify-between gap-3">
                    ...
                    <div className="flex gap-2 items-center">
                      <Button variant="outline" size="iconXl" onClick={() => triggerRefresh()} className="rounded-full">
                        <FontAwesomeIcon icon={faRotateRight} className="text-foreground/80 transition-colors text-lg duration-300" />
                      </Button>
                      <Button
                        variant="outline"
                        size="iconXl"
                      ...
                      <Button variant="outline" size="iconXl" onClick={() => setTheme(whatTheme === "dark" ? "light" : whatTheme === "aqua" ? "dark" : "aqua")} className="rounded-full">
                        <FontAwesomeIcon icon={faCircleHalfStroke} className="text-foreground/80 transition-colors text-lg duration-300" />
                      </Button>
                    </div>
                  </div>
                </div>
