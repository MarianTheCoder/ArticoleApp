    ...
    return (
        <>
            ...
            <Collapsible
                ...
                className="pontaje-calendar rounded-xl bg-card shadow-md w-full"
            >
                {/* Trigger / Header */}
                <CollapsibleTrigger asChild>
                    <button className="flex items-center justify-between w-full px-5 py-4 hover:bg-accent transition-colors ">
                        <div className="flex items-center gap-2">
                            <FontAwesomeIcon icon={faCalendarDays} className="text-primary text-xl" />
                            <span className="text-base font-semibold text-foreground">
                                Calendar - Săptămâna {getWeek(new Date(), { weekStartsOn: 1 })}
                            </span>
                        </div>
                        <FontAwesomeIcon
                            icon={faChevronDown}
                        ...
                        <div className="flex justify-center select-none w-full">
                            <DayPicker
                                ...
                                classNames={{
                                    ...
                                    button_previous: "absolute z-50 left-0 top-0 h-10 w-10 flex items-center justify-center rounded-md bg-primary hover:bg-primary/90 text-muted-foreground hover:text-foreground transition-colors",
                                    button_next: "absolute z-50 right-0 top-0 h-10 w-10 flex items-center justify-center rounded-md bg-primary hover:bg-primary/90 text-muted-foreground hover:text-foreground transition-colors",
