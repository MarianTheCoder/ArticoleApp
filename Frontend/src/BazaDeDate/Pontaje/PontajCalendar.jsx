...
export const PontajeCalendar = memo(
  ({ selectedDates, setSelectedDates, onReset }) => {
    ...
    return (
      <>
        ...
        <Collapsible
          ...
          className="pontaje-calendar rounded-xl bg-card shadow-md border  w-full"
        >
          {/* Trigger / Header */}
          <CollapsibleTrigger asChild>
            <button
              className={`flex items-center selectedRow justify-between w-full ${open ? "rounded-t-xl" : "rounded-xl"}  px-5 py-4 hover:bg-accent transition-colors `}
            >
              ...
              <div className="flex justify-center select-none w-full">
                <DayPicker
                  ...
                  classNames={{
                    ...
                    month_caption:
                      "flex justify-center items-center py-2 relative",
                    caption_label:
                    ...
                    weekday:
                      "text-muted-foreground flex-1 text-center text-base font-medium py-2",
                    week: "flex w-full mt-1 gap-1",
                    week_number:
                      "text-sm  text-muted-foreground w-10 flex items-center justify-center",
