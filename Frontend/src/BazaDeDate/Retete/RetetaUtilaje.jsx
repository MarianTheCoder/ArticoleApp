...
export default function RetetaUtilaje({
    ...
    fetchPreviewReteta,
            ...
            try {
                if(utilajeFilters.clasa_utilaj.trim().length >= 3 || utilajeFilters.descriere_utilaj.trim().length >= 3 || utilajeFilters.utilaj.trim().length >= 3){
                    const response = await api.get('/Utilaje/api/utilajeLight', {
                        params: {
                            cod_utilaj: utilajeFilters.cod_utilaj,
        ...
        const columns = useMemo(() => [
            ...
            { accessorKey: "cod_utilaj", header: "Cod",size:50 },
            { 
  ...
  return (
    <>
        <div className=' flex flex-col h-full w-full overflow-hidden'>
            ...
            <div className='grid font-medium grid-cols-[auto_1fr_2fr_1fr_2fr_auto] gap-4 p-4 pt-2 text-black containerWhiter w-full'>
