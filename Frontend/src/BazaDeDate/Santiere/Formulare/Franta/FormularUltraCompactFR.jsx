...
export const FormularUltraCompactFR = async (id, recapitulatii, TVA, reper1, reper2) => {
    let res;
    try {
        res = await api.get(`/Formulare/generareRasfiratByPartSUM/${id}`, {
            params: {
    ...
    const tableBody = [
        [
            ...
            { text: 'Article Client', style: 'mainHeader' },
    ...
    pdfMake.createPdf(docDefinition).download(`${santierName}_${ofertaName}_${ofertaPartName}.pdf`);
