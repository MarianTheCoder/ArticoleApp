...
import { useAddComment, useComments, useEditComment } from "@/hooks/Database/useRezerve";
                  ...
                  <Card onClick={() => console.log(c)} key={c.id} className="rounded-2xl border-input shadow-sm hover:shadow-md transition-all">
                    <div className="p-4">
                      ...
                      <div className="text-foreground leading-relaxed mt-2">
                        {c.body_text ? <p className="whitespace-pre-wrap text-sm">{c.body_text}</p> : <span className="text-muted-foreground italic text-sm">Fără descriere</span>}
                      </div>
