  ...
  return (
    <div className="grid grid-cols-[1fr_5fr] h-full w-full bg-background gap-6 rounded-lg p-6">
      <div className="w-full h-full  overflow-hidden rounded-lg">
        <SidebarRezerve onSelectPlan={handleSelectPlan} onSelectLucrare3D={handleSelectLucrare3D} selectedPlanSideBar={selectedPlan} />
      </div>
      ...
      <div className="w-full h-full p-4 bg-card rounded-lg">
        {selectedPlan ? (
          ...
          <div className="flex items-center justify-center h-full w-full">
            <div className="text-2xl text-gray-500 select-none">Selecteazǎ un plan sau o lucrare 3D</div>
          </div>
        )}
      </div>
    </div>
