...
import HistoryTab from "@/CRM/History/HistoryTab";
import CompanyActivities from "@/CRM/Companies/Activity/CompanyActivities";
          ...
          <Tabs defaultValue="locatie" className="h-full w-full flex flex-col gap-4">
            ...
            <div className="flex-1 bg-card overflow-y-auto h-full border rounded-lg">
              ...
              <TabsContent value="istoric" className="h-full m-0 relative w-full">
                <HistoryTab companyId={s?.companie_id} santierId={s?.id} />
              </TabsContent>
