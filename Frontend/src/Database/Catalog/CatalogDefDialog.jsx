...
const formatOptionalDecimalInputValue = (value) => {
  ...
  return Number.isFinite(numberValue) ? numberValue.toFixed(2).replace(".", ",") : "";
};
  ...
  useEffect(() => {
    ...
    const initializeData = async () => {
      ...
      setDraft({
        ...
        greutate: tipResursa === "material" ? formatOptionalDecimalInputValue(initialData.greutate) : "",
              ...
              <div className="flex items-end gap-3 xxxl:gap-4">
                ...
                <div className="flex-1">
                  ...
                  <h2 className="text-lg xxxl:text-xl font-bold text-foreground leading-tight">
                    {isDuplicateMode ? `Dublează ${config.title.toLowerCase()}` : actualMode === "edit" ? `Editează ${config.title.toLowerCase()}` : `${config.title} nou`}
                  </h2>
                </div>
              </div>
            </div>
            ...
            <div className="px-4 xxxl:px-6 py-3 xxxl:py-4 flex flex-col gap-3 xxxl:gap-4 overflow-y-auto max-h-[65vh]">
              ...
              <div className="flex flex-col gap-1.5 xxxl:gap-2">
                ...
                <div className="flex gap-4 xxxl:gap-5 items-end">
                  ...
                  <div className={`flex-1 grid ${tipResursa === "material" ? "grid-cols-[1fr_0.5fr_0.5fr_0.5fr_0.5fr]" : "grid-cols-4"} gap-2.5 xxxl:gap-3 mb-1`}>
                    ...
                    <div className="flex flex-col gap-1 xxxl:gap-1.5">
                      <Label className="text-xs xxxl:text-sm font-semibold">Cost unitar</Label>
                    ...
                    {tipResursa === "material" && (
                      <div className="flex flex-col gap-1 xxxl:gap-1.5">
                        <Label className="text-xs xxxl:text-sm font-semibold">Greutate (kg)</Label>
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            if (/^\d{0,5}\,?\d{0,2}$/.test(val)) setField("greutate", val);
                          }}
                          placeholder="0,00"
                          className="h-9"
                        />
