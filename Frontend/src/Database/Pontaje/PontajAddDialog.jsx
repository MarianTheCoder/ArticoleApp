      ...
      <div className="p-4 grid gap-4">
        ...
        <div className="grid gap-1.5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Input type="number" step="any" className="h-9  text-sm" placeholder="Latitudine (ex: 47.1691)" value={session.start_lat} onChange={(e) => set("start_lat", e.target.value)} />
            <Input type="number" step="any" className="h-9  text-sm" placeholder="Longitudine (ex: 27.5941)" value={session.start_lng} onChange={(e) => set("start_lng", e.target.value)} />
          </div>
        </div>
        ...
        <div className="grid gap-1.5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Input type="number" step="any" className="h-9  text-sm" placeholder="Latitudine (ex: 47.1691)" value={session.end_lat} onChange={(e) => set("end_lat", e.target.value)} />
            <Input type="number" step="any" className="h-9  text-sm" placeholder="Longitudine (ex: 27.5941)" value={session.end_lng} onChange={(e) => set("end_lng", e.target.value)} />
          </div>
        </div>
      </div>
    </div>
