...
export default function ManoperaForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.cod_definitie === "" || form.ocupatie === "" || form.limba === "" || form.unitate_masura === "" || isNaN(form.cost_unitar) || form.cost_unitar < 0) {
  ...
  const deleteRow = async (e) => {
    e.preventDefault();
    try {
      const response = await api.delete(`/Manopera/DeleteManoperaDef/${selectedDelete}`);
            ...
            <div className="grid grid-cols-[auto_auto_1fr_auto_auto_auto] xxxl:gap-6 md:gap-2 xl:gap-4 items-center">
              ...
              <div className=" grid grid-cols-[auto_1fr_2fr] gap-4 border p-2 rounded-lg border-black">
                ...
                {!itIsFR ? (
                  <>
                    <div className="flex flex-col items-center">
                      <label className=" font-medium text-black">Ocupație</label>
                      <textarea
                        rows={1}
                        type="text"
                        id="ocupatie"
                  ...
                  <>
                    <div className="flex flex-col items-center">
                      <label className=" font-medium text-black">Ocupație FR</label>
                      <textarea
                        type="text"
                        rows={1}
                        id="ocupatie_fr"
