...
export default function PopupAddManopera({ setIsPopupOpen, isPopupOpen, open, setOpen, delPreviewManopera, fetchPreviewManopera }) {
        ...
        <div className="flex justify-center items-center text-black  ">
          <form onSubmit={handleSubmit} className="w-full p-6 pt-4 md:px-4 xl:px-8 rounded-xl ">
            <div className="grid grid-cols-[auto_1fr_1fr_auto_auto_auto] xxxl:gap-12 md:gap-6 xl:gap-8 items-center">
              ...
              <div className="flex flex-col items-center">
                <label htmlFor="cost_unitar" className=" font-medium text-black">
                  Cost Unitar
                </label>
                <input
                  type="text"
              ...
              <div className="flex flex-col items-center">
                <label htmlFor="cantitate" className=" font-medium text-black">
                  Cantitate
                </label>
                <input
                  type="text"
              ...
              <div className="flex gap-2 items-center ">
                <button type="submit" className="bg-green-500 hover:bg-green-600 text-black text-lg mt-6 px-6 py-2 flex  items-center rounded-lg">
