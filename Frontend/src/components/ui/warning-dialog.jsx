...
import { faQuestionCircle, faCheck, faExclamationTriangle, faExclamation } from "@fortawesome/free-solid-svg-icons";
            ...
            <DialogContent className="sm:max-w-xl p-8 gap-8 border shadow-2xl">
                    ...
                    <div className="mb-4">
                        <div className="bg-yellow-50 dark:bg-yellow-950/40 p-5 rounded-2xl flex items-center justify-center ring-1 ring-yellow-100 dark:ring-yellow-900 shadow-sm">
                            <FontAwesomeIcon
                                ...
                                className="text-yellow-600 dark:text-yellow-400 text-5xl"
                            />
                        </div>
                    </div>
                ...
                <DialogFooter className="flex flex-col sm:flex-row gap-3 sm:justify-center w-full">
                    ...
                    <Button
                        ...
                        className="gap-2 bg-yellow-600 hover:bg-yellow-700 text-white shadow-md hover:shadow-lg transition-all text-base min-w-[120px]"
                    >
