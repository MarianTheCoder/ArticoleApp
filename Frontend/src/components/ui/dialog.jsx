...
const DialogOverlay = React.forwardRef(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay ref={ref} className={cn("fixed inset-0 z-50 bg-black/60   data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 keepSelection", className)} {...props} />
));
